...
# SE CREA UNA FUNCIÓN PARA GENERAR LA MATRIZ INICIAL USANDO NUMPY:
...
def main():
    ...
    for gen in range(generaciones):
        ...
        # Dividir la matriz por bloques (una parte para cada hilo)
    ...
    print(f"Tiempo total de ejecución paralela2: {end - start:.2f} segundos")
